...
search[cities_] := 
 Module[{min, travel, d, minDistance = Infinity, shortEdges, format},
  ...
  shortEdges = 
   Sort[Flatten[
     Table[d[i, j], {i, 1, Length[cities] - 1}, {j, i + 1, 
       Length[cities]}]], Less];
  ...
  travel[visited_, len_, remain_] :=
   ...
   If[len + Sum[shortEdges[[i]], {i, 1, Length[remain] + 1}] > 
    ...
    min[Map[
      ...
      If[Length[visited] == 2, Select[remain, # < First[visited] &], 
       remain]]]];
...
q2 = {{9007199254742147, 18014398509481729}, {12756043757992973, 
    9682416912451847}, {7757599369284503, 
    13555003989651347}, {6644379103590211, 
    16459957280325781}, {7107267045169859, 
    11361149298161843}, {17193260969299, 
    17215263416918057}, {374711875842439, 
    13679925148827797}, {9007199254742149, 18014398509481727}};

q3 = {{24450478250354407, 24162405956350007}, {5022777106905113, 
    9351872806120363}, {22646143480201399, 
    18046391278629037}, {26904592918639433, 
    8822422244422001}, {13510798882112671, 
    27021597764225159}, {7416604674633347, 
    17884308649058737}, {11322174193520947, 
    3885286011386431}, {25871043906094921, 
    9505143934995377}, {12509125559334347, 
    10427194051934741}, {13510798882112669, 27021597764225161}};

q4 = {{143440002785145229, 125304038892333277}, {264428432131034503, 
    120015772829769617}, {128790875003948837, 
    270669230395068511}, {159528435868345829, 
    204968426098505873}, {19849988012900029, 
    184555790037852601}, {275289191011264097, 
    71741794408943803}, {10351044942542977, 
    120950333572309643}, {256393278357970813, 
    144044348649819451}, {144115188075856001, 
    288230376151712791}, {144115188075856003, 
    288230376151712789}, {219455401629103741, 
    10320154786742321}, {227161482167126027, 70606670735479337}};
